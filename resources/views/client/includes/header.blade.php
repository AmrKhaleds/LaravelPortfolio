                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        <a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i
                            ...
                            <span id="notification_count" class="badge badge-pill badge-default badge-danger badge-default badge-up badge-glow">{{isset($notificationCount)? $notificationCount:0}}</span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                ...
                                <span class="notification-tag badge badge-default badge-danger float-right m-0">{{isset($notificationCount)? $notificationCount:0}}
                                    New</span>
                            </li>
                                        ...
                                        <a href="javascript:void(0)">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <h6 class="media-heading">{{$notify->data['message']}}</h6>
                                                    <p class="notification-text font-small-3 text-muted">Lorem ipsum dolor sit
                                                        amet, consectetuer elit.</p>
                                                    <small>
                                                        <time class="media-meta text-muted"
                                                            datetime="2015-06-11T18:29:20+08:00">{{ $notify->created_at->diffForHumans() }}
                                                        </time>
                                                    </small>
                                                </div>
                                            </div>
