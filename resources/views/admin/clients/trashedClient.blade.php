                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">All Trashed Clients</h4>
                                                            ...
                                                            <td>
                                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                                    <form action="{{ route('client.trashed.restore', $client->username) }}" method="POST">
                                                                        ...
                                                                        @csrf
                                                                        <button type="submit"
                                                                            class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">RESTOR</button>
                                                                    </form>
                                                                    <form action="" method="POST">
                                                                        @method('DELETE')
                                                                        @csrf
                                                                        <button type="submit"
                                                                            class="btn btn-outline-danger btn-min-width box-shadow-3 mr-1 mb-1">TOTALY DELETE</button>
                                                                    </form>
                                                                </div>
                                                            </td>
                                                        </tr>
