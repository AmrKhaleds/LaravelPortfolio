                                                        ...
                                                        <div class="form-group">
                                                            <label for="project_type">Project Type</label>
                                                                <select name="project_type[]" id="project_type" class="form-control" multiple>
                                                                    <option {{ old('project_type') == '' ? 'selected' : '' }} disabled>Select Value</option>
                                                                    <option {{ old('project_type') == 'photo' ? 'selected' : '' }}>Photo</option>
                                                                    <option {{ old('project_type') == 'video' ? 'selected' : '' }}>Video</option>
                                                                    <option {{ old('project_type') == 'marketing' ? 'selected' : '' }}>Marketing</option>
                                                                    <option {{ old('project_type') == 'website' ? 'selected' : '' }}>Website</option>
                                                                </select>
                                                            @error('project_type')
