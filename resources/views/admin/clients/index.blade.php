                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                                    <a href="{{ route('clients.show', $client->username) }}" class="btn btn-primary btn-sm rounded-5 mr-1">
                                                                        <i class="la la-eye"></i>
                                                                    </a>
                                                                    <a href="{{ route('clients.edit', $client->username) }}" class="btn btn-secondary btn-sm rounded-5 mr-1">
