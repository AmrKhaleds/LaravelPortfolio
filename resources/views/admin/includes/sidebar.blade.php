    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item">
                ...
                <ul class="menu-item">
                    <li>
                        <a class="menu-item" href="{{ route('project.index') }}" data-i18n="nav.dash.ecommerce"> All Projects</a>
                    </li>
                    <li><a class="menu-item" href="{{ route('project.create') }}" data-i18n="nav.dash.crypto">Add New Project</a>
                    </li>
                </ul>
            </li>
