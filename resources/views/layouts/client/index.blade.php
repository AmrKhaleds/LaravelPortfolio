...
<body
    ...
    @if (Request::is('assets/users/tickets/reply*')) chat-application @endif menu-expanded fixed-navbar "
    ...
    @yield('page_level_js')
    <script src="{{ asset('assets/admin/js/scripts/tables/datatables/datatable-advanced.js') }}" type="text/javascript">
    </script>
    <!-- END PAGE LEVEL JS-->
    ...
    <script>
        ...
        messaging.requestPermission()
            ...
            .then(function(token) {
                ...
                */
                $.ajax({
                    url: "{{ route('client.save_device_token') }}",
                    type: 'POST',
                    data: {
                        device_token: token,
                        _token: '{{ csrf_token() }}'
        ...
        messaging.onMessage((payload) => {
            ...
            // console.log(.message);
            const noteData = JSON.parse(payload.data.fcmapp);
