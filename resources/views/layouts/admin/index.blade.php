...
<html class="loading" lang="en" data-textdirection="ltr">
    <head>
        ...
        <!-- END VENDOR CSS-->
        <link rel="stylesheet" type="text/css" href="{{ asset('https://cdn.datatables.net/1.13.4/css/jquery.dataTables.min.css') }}">
    ...
    @endif menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu" data-col="2-columns">
        ...
        <script src="{{ asset('https://cdn.datatables.net/1.13.4/js/jquery.dataTables.min.js') }}" type="text/javascript"></script>
